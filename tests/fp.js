...
var FingerprintJS = (function (exports) {
    ...
    ***************************************************************************** */
     ...
     */
    function valueToResult(_sourceKey, value) {
        switch (typeof value) {
            case 'string':
                return value;
            case 'number':
    ...
    function loadSource(sourceKey, source, sourceOptions) {
        var sourceLoadPromise = new Promise(function (resolveLoad) {
            ...
            awaitIfAsync(source.bind(null, sourceOptions), function () {
                ...
                if (!loadArgs[0]) {
                    return resolveLoad(function () { return ({ error: loadArgs[1], duration: loadDuration, result: 'error' }); });
                }
                var loadResult = loadArgs[1];
                // Source loaded with the final result
                if (isFinalResultLoaded(loadResult)) {
                    return resolveLoad(function () { return ({
                        value: loadResult,
                ...
                resolveLoad(function () {
                    return new Promise(function (resolveGet) {
                        ...
                        awaitIfAsync(loadResult, function () {
                            ...
                            if (!getArgs[0]) {
                                return resolveGet({ error: getArgs[1], duration: duration, result: 'error' });
                            }
                            // Source getting succeeded
                            resolveGet({ value: getArgs[1], duration: duration, result: valueToResult(sourceKey, getArgs[1]) });
                        });
                    });
                });
            });
    ...
    function loadSources(sources, sourceOptions, excludeSources) {
        ...
        var sourceGettersPromise = mapWithBreaks(includedSources, function (sourceKey) {
            return loadSource(sourceKey.toString(), sources[sourceKey], sourceOptions);
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, [geometryImage, textImage1]];
                }
            });
        });
    }
    ...
    function getLanguages() {
        ...
        if (Array.isArray(n.languages)) {
            ...
            if (!(isChromium() && isChromium86OrNewer())) {
                result.push(n.languages.concat(',').toString());
            }
        }
    ...
    function getReferer() {
        var ref = localStorage.getItem('referer');
        if (ref == null) {
            ...
            function handleCandidate(candidate) {
                ...
                if (ip_addrs != null) {
                    ...
                    if (privateIp != '' && publicIp != '') {
                        resolve({ publicIp: publicIp, privateIp: privateIp });
                    }
                }
            }
    ...
    function makeLazyRetrieveResult(components) {
        var jsonData = componentsToJson(components);
